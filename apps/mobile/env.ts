...
const BUNDLE_IDS = {
  development: 'cm.cropdoctor.development',
  preview: 'cm.cropdoctor.preview',
  production: 'cm.cropdoctor',
} as const;
...
const SCHEMES = {
  development: 'cropDoctor',
  preview: 'cropDoctor.preview',
  production: 'cropDoctor',
} as const;

const NAME = 'Crop Doctor';
